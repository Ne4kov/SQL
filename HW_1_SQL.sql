...
-- вывести всех студентов у которых password = 12333 
select * from students
...
--31. Вывести id пользователя, 
--имя, дату создания пользователя.
